...
\draw [ gray] (0.525,0.83) -- (0.78,0.83);
...
\draw [ gray] (0.62,0.32) -- (0.78,0.32);
\node[text width=1.5cm] at (0.835,0.32) {Chiquimula \\  \zacapa };

%#############JALAPA################################# %
\filldraw [gray] (0.55,0.20) circle (1.2pt);
\draw [ gray] (0.65,0.20) -- (0.65,0.25);
\draw [ gray] (0.65,0.25) -- (0.90,0.25);
